...
`MD3Expressive.Maui` es una librería de componentes de alto rendimiento para **.NET MAUI** con controles portados desde **Jetpack Compose** (Android) e inspirados en los lineamientos de diseño de **Material 3 Expressive**, potenciada internamente por **SkiaSharp** y optimizada para evitar la sobrecarga de recolección de basura (GC Churn).
