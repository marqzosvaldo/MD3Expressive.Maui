...
Este repositorio es una librería ligera de componentes visuales de alto rendimiento basados en **Jetpack Compose** (Android) e inspirados en **Material 3 Expressive** y **SkiaSharp** para .NET MAUI.
